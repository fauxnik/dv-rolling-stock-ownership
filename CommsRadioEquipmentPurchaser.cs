...
namespace DVOwnership
{
    public class CommsRadioEquipmentPurchaser : MonoBehaviour, ICommsRadioMode
    {
        ...
        {
            var content = string.Format(CONTENT_SELECT_CAR, SelectedCarType.ToString(), carPrice.ToString("F0"), CanAfford ? "" : CONTENT_FRAGMENT_INSUFFICIENT_FUNDS);
        ...
        {
            var content = string.Format(CONTENT_SELECT_DESTINATION, SelectedCarType.ToString(), carLength.ToString("F"), CanAfford ? "" : CONTENT_FRAGMENT_INSUFFICIENT_FUNDS);
        ...
        {
            var content = string.Format(CONTENT_CONFIRM_PURCHASE, SelectedCarType.ToString(), carPrice.ToString("F0"), CanAfford ? "" : CONTENT_FRAGMENT_INSUFFICIENT_FUNDS);
