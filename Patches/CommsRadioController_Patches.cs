...
namespace DVOwnership.Patches
{
	public static class CommsRadioController_Patches
	{
		...
		public static void Setup()
		{
			if (isSetup)
			{
				DVOwnership.LogWarning("Trying to set up comms radio controller patches, but they've already been set up!");
				return;
			}

			DVOwnership.Log("Setting up CommsRadioController patches.");
			...
			DVOwnership.Patch(CommsRadioController_UpdateModesAvailability, postfix: new HarmonyMethod(CommsRadioController_UpdateModesAvailability_Postfix));
		}
